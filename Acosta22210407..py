# -*- coding: utf-8 -*-
"""
Created on Tue May 20 15:42:37 2025
...
kP, kI, kD, Cr = 37.5678, 1936.8002 ,1936.8002, 1E-6
Re = 1/(kI*Cr)
Rr = kP*Re
Ce = kD/Rr
...
y_tratamiento = y_normal.copy()                        # Green dashed version of normal

# Plot configuration
plt.figure(figsize=(12, 6))
plt.plot(t, y_normal, color='blue', linewidth=2, label='Normal Case')
plt.plot(t, y_hpb, color='red', linewidth=2, label='HPB Case')
plt.plot(t, y_tratamiento, color='orange', linewidth=2, linestyle='--', label='Tratamiento')  # New signal
